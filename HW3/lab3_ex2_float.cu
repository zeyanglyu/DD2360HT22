...
int main(int argc, char **argv) {
  ...
  double CPU_Stop = getTimer() - CPU_Start;
  printf("CPU Time: %f\n", CPU_Stop);
  ...
  double H2D_Time = getTimer() - start;
